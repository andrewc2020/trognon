...
describe('Local State', () => {
  ...
  const promise = Promise.resolve(result);
   ...
   describe('react tests with enzyme',()=>{
    before(() => {
      sinon.stub(axios, 'get').withArgs('http://mypseudodomain/counter').returns(promise);
    });
    ...
    after(() => {
     ...
     it('should find a tag called Counter with a length of 1',()=>{
      const state = { counter: 0 };
